...
export interface ITopicHistoryRepository {
    ...
    findByTopicIdAndVersion(topicId: string, version: HistoryAction): Promise<TopicHistory[]>;
    getLatestVersion(topicId: string): Promise<TopicHistory | null>;
    getNextVersionNumber(topicId: string): Promise<number>;
    compareVersions(topicId: string, version1: number, version2: number): Promise<{
