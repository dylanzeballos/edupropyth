...
export const MyCoursesPage = () => {
  ...
  const { enrolledCourses, availableCourses, isLoading, error } = useMyCoursesLogic();
        ...
        {availableCourses.length > 0 && (
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Estos cursos están disponibles pero aún no estás inscrito. Usa un código de matrícula para inscribirte.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
